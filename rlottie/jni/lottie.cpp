...
// https://github.com/DrKLO/Telegram/blob/master/TMessagesProj/jni/lottie.cpp
// with class and method references replaced with Discord class references
...
JNIEXPORT jlong Java_com_discord_rlottie_RLottieDrawable_00024Companion_create(JNIEnv *env, jclass clazz, jstring src, jint w, jint h, jintArray data, jboolean precache, jintArray colorReplacement, jboolean limitFps) {
...
JNIEXPORT jlong Java_com_discord_rlottie_RLottieDrawable_00024Companion_createWithJson(JNIEnv *env, jclass clazz, jstring json, jstring name, jintArray data, jintArray colorReplacement) {
    std::map<int32_t, int32_t> *colors = nullptr;
    if (colorReplacement != nullptr) {
        jint *arr = env->GetIntArrayElements(colorReplacement, 0);
        if (arr != nullptr) {
...
JNIEXPORT void Java_com_discord_rlottie_RLottieDrawable_00024Companion_destroy(JNIEnv *env, jclass clazz, jlong ptr) {
    if (!ptr) {
        return;
    }
...
JNIEXPORT void Java_com_discord_rlottie_RLottieDrawable_00024Companion_setLayerColor(JNIEnv *env, jclass clazz, jlong ptr, jstring layer, jint color) {
...
JNIEXPORT void Java_com_discord_rlottie_RLottieDrawable_00024Companion_replaceColors(JNIEnv *env, jclass clazz, jlong ptr, jintArray colorReplacement) {
...
JNIEXPORT void Java_com_discord_rlottie_RLottieDrawable_00024Companion_createCache(JNIEnv *env, jclass clazz, jlong ptr, jint w, jint h) {
    if (ptr == NULL) {
        return;
    }
    LottieInfo *info = (LottieInfo *) (intptr_t) ptr;
...
JNIEXPORT jint Java_com_discord_rlottie_RLottieDrawable_00024Companion_getFrame(JNIEnv *env, jclass clazz, jlong ptr, jint frame, jobject bitmap, jint w, jint h, jint stride, jboolean clear) {
